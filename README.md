...
Aplikasi iReader adalah aplikasi iOS Aplikasi Barcode dan Pemindai Teks Langsung dengan SwiftUI, AVKit, dan VisionKit (On Device Machine Learning Processing).
